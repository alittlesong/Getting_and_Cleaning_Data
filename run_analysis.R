...
# and 66 mean and standard deviation features are averaged for each group. 
# The resulting data table has 180 rows and 69 columns – 33 Mean variables 
# + 33 Standard deviation variables + 1 Subject( 1 of of the 30 test subjects) + ActivityName + ActivityNum . 
